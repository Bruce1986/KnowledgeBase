...
- 【協助流程】 (Assistance Workflow)：
  當使用者請求你提供「優點」、「風險」或其他欄位的內容時，你僅能在 AI Log 中給出建議、要點或草稿，供使用者自行複製到對應章節。你不得直接編輯那些章節。你所有的分析僅供參考，必須完整記錄在 AI Log 中，等待使用者審閱與採納。紀錄完成後，請通知使用者審閱並手動更新資訊。

- 【核心禁止行為】 (Core Guardrail)：
AI 絕對禁止編輯 `## 99. AI 分析日誌` 區塊以外的任何內容。
